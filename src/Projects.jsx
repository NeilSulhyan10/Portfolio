export default function Projects() {
  ...
  const autoscrollProjects = [...projects, ...projects];
    ...
    <section className="my-20 overflow-hidden">
      ...
      <div className="relative">
        <div className="flex animate-scroll hover:[animation-play-state:paused]">
          {autoscrollProjects.map((project, index) => (
            <div
              key={index}
              className="bg-gradient-to-r from-teal-500 to-blue-600 dark:bg-gradient-to-r from-gray-700 to-gray-600 rounded-lg shadow-xl p-6 mx-3 w-80 h-[350px] flex flex-col justify-between transition-transform transform hover:scale-105 flex-shrink-0 h-64"
            >
